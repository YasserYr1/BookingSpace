        ...
        <div>
            ...
            <div>
                {bookings?.length > 0 && bookings.map(booking =>(
                    <Link to={`/account/bookings/${booking._id}`} className="flex gap-4 bg-transparent border shadow-lg hover:shadow-xl rounded-2xl overflow-hidden">
                        <div className="w-48">
                            <PlaceImg place={booking.place} className="h-full"/>
                        </div>
                        <div className="py-3 pr-3 grow ml-6">
